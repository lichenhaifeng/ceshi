                        ...
                        <table id="sample-table-1" class="table table-striped table-bordered table-hover">
                            ...
                            @foreach($user as $key=>$v)
                                ...
                                <tr id="lis{{$v->id}}">
                                    ...
                                    <td><label><input type="checkbox"  value="{{$v->id}}" name="chckBox"  class='ace' > <span class="lbl"></span> </label></td>
                                    <td class="hidden-480"><img src="{{URL($v->img)}}"  width="50" height="50"> </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
                                            ...
                                            <a href="javascript:void(0)" onclick="fun({{$v->id}})"><button class="btn btn-xs btn-danger"> <i class="icon-trash bigger-120"></i> </button> </a>
