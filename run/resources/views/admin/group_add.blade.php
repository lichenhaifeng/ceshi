  ...
  <link rel="stylesheet" href="{{url('assets/css/ace-skins.min.css')}}" /> 
     ...
     <div class="page-content"> 
      ...
      <div class="page-header"> 
       ...
       <h1>礼品管理<small> <i class="icon-double-angle-right"></i>礼品添加</small> </h1> 
       ...
       <div class="col-xs-12"> 
        ...
        <div class="row"> 
         ...
         <div class="col-xs-12"> 
          ...
          <form action="{{url('group_add')}}" method="post" enctype="multipart/form-data" onsubmit="return  sad()">
           ...
           <table id="sample-table-1" class="table table-striped table-bordered table-hover"> 
            ...
            <tr>
              ...
              <td>
                ...
                <input type="text"  class="easyui-textbox"  name="l_name"   id="name"  onblur="c_name()"/>
            ...
            <tr>
              ...
              <td>
                ...
                <input type="text"  class="easyui-textbox"   name="l_sum"  id="sum"  onblur="s_sum()" />
            ...
            <tr>
                ...
                <td><input type="text"  class="easyui-textbox"   name="l_num"   id="num"  onblur="s_num()"/>

                        <span id="k_num"></span></td>

            </tr>

            <tr>

              <td align="center">礼品头像：</td>
...
<script type="text/javascript">
    ...
    function s_sum(){
        ...
        var   re=document.getElementById('sum').value;

        qq=/^\d{1,}$/;

        if(re==""){

            document.getElementById('k_sum').innerHTML="不能为空";
            ...
            if(!ww){
                ...
                document.getElementById('k_sum').innerHTML="格式不正确";

                flag=false;

            }else{

                document.getElementById('k_sum').innerHTML="ok";
    ...
    function s_num(){
        ...
        if(re==""){
            ...
            document.getElementById('k_num').innerHTML="不能为空";
            ...
            if(!ww){
                ...
                document.getElementById('k_num').innerHTML="格式不正确";

                flag=false;

            }else{

                document.getElementById('k_num').innerHTML="ok";
